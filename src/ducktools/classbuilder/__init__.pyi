...
@typing.type_check_only
class _GenericCodegenType(typing.Protocol):
...
class CachedMethodMaker:
    funcname: str
    arg_getter: Callable[[type], tuple[str, ...]]
    generic_code_generator: _GenericCodegenType
    call_outer: bool
    _cache: dict[int, types.FunctionType]
    ...
    def __repr__(self) -> str: ...
    @property
    def code_generator(self) -> _CodegenType: ...
    def get_method(self, cls: type, funcname: str) -> types.FunctionType: ...
    def __get__(self, instance, cls) -> types.FunctionType: ...
...
def get_compare_args(cls: type) -> tuple[str, ...]: ...
...
def repr_generator(cls: type, funcname: str = ...) -> GeneratedCode: ...
def eq_generator(cls: type, funcname: str = ...) -> GeneratedCode: ...

def generic_eq_generator(argcount: int, funcname: str = ...) -> GeneratedCode: ...
...
def replace_generator(cls: type, funcname: str = ...) -> GeneratedCode: ...
